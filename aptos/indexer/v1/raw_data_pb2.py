...
from aptos.indexer.v1 import filter_pb2 as aptos_dot_indexer_dot_v1_dot_filter__pb2
...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'aptos.indexer.v1.raw_data_pb2', _globals)
if not _descriptor._USE_C_DESCRIPTORS:
  DESCRIPTOR._loaded_options = None
  _globals['_GETTRANSACTIONSREQUEST'].fields_by_name['starting_version']._loaded_options = None
  _globals['_GETTRANSACTIONSREQUEST'].fields_by_name['starting_version']._serialized_options = b'0\001'
  _globals['_GETTRANSACTIONSREQUEST'].fields_by_name['transactions_count']._loaded_options = None
  _globals['_GETTRANSACTIONSREQUEST'].fields_by_name['transactions_count']._serialized_options = b'0\001'
  _globals['_TRANSACTIONSRESPONSE'].fields_by_name['chain_id']._loaded_options = None
  _globals['_TRANSACTIONSRESPONSE'].fields_by_name['chain_id']._serialized_options = b'0\001'

...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in aptos/internal/fullnode/v1/fullnode_data_pb2_grpc.py depends on'
...
def add_FullnodeDataServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('aptos.internal.fullnode.v1.FullnodeData', rpc_method_handlers)
...
class FullnodeData(object):
    ...
    @staticmethod
    def GetTransactionsFromNode(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
